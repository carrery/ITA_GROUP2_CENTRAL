 ...
 * 
 */
@WebServiceClient(name = "MyCalculatorService", targetNamespace = "http://webservice.sw1.bituiga.oocl.com/", wsdlLocation = "http://zha-ita140-w7:8080/BITUIGA22AUG/MyCalculatorService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName MYCALCULATORSERVICE_QNAME = new QName("http://webservice.sw1.bituiga.oocl.com/", "MyCalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://zha-ita140-w7:8080/BITUIGA22AUG/MyCalculatorService?WSDL");
    ...
    public MyCalculator getMyCalculatorPort() {
        return super.getPort(new QName("http://webservice.sw1.bituiga.oocl.com/", "MyCalculatorPort"), MyCalculator.class);
    }
    ...
    public MyCalculator getMyCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.sw1.bituiga.oocl.com/", "MyCalculatorPort"), MyCalculator.class, features);
    }
