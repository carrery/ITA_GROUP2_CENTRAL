 ...
 * generated in the com.oocl.bangipr.sw1 package. 
...
public class ObjectFactory {
    ...
    private final static QName _MultiplicationResponse_QNAME = new QName("http://sw1.bangipr.oocl.com/", "MultiplicationResponse");
    private final static QName _SubtractionResponse_QNAME = new QName("http://sw1.bangipr.oocl.com/", "SubtractionResponse");
    private final static QName _Subtraction_QNAME = new QName("http://sw1.bangipr.oocl.com/", "Subtraction");
    private final static QName _Addition_QNAME = new QName("http://sw1.bangipr.oocl.com/", "Addition");
    private final static QName _Multiplication_QNAME = new QName("http://sw1.bangipr.oocl.com/", "Multiplication");
    private final static QName _AdditionResponse_QNAME = new QName("http://sw1.bangipr.oocl.com/", "AdditionResponse");
    private final static QName _DivisionResponse_QNAME = new QName("http://sw1.bangipr.oocl.com/", "DivisionResponse");
    private final static QName _Division_QNAME = new QName("http://sw1.bangipr.oocl.com/", "Division");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.oocl.bangipr.sw1
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sw1.bangipr.oocl.com/", name = "MultiplicationResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sw1.bangipr.oocl.com/", name = "SubtractionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sw1.bangipr.oocl.com/", name = "Subtraction")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sw1.bangipr.oocl.com/", name = "Addition")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sw1.bangipr.oocl.com/", name = "Multiplication")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sw1.bangipr.oocl.com/", name = "AdditionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sw1.bangipr.oocl.com/", name = "DivisionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sw1.bangipr.oocl.com/", name = "Division")
