 ...
 * generated in the com.oocl.licupca.misc.ws.main package. 
...
public class ObjectFactory {
    ...
    private final static QName _CalculateResponse_QNAME = new QName("http://main.ws.misc.licupca.oocl.com/", "calculateResponse");
    private final static QName _Calculate_QNAME = new QName("http://main.ws.misc.licupca.oocl.com/", "calculate");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.oocl.licupca.misc.ws.main
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://main.ws.misc.licupca.oocl.com/", name = "calculateResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://main.ws.misc.licupca.oocl.com/", name = "calculate")
